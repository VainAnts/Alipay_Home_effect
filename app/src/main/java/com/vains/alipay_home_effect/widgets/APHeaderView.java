package com.vains.alipay_home_effect.widgets;
...
import com.vains.alipay_home_effect.R;
import com.vains.alipay_home_effect.widgets.support.ATHeaderBehavior;
...
public class APHeaderView extends ViewGroup {
    ...
    protected void onFinishInflate() {
        ...
        mBar = findViewById(R.id.my_bar);
        mSnapView = findViewById(R.id.my_snap);
